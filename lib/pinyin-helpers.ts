...
const FORCED_PRONUNCIATION_LEXICON: ReadonlyArray<{
  ...
  { term: "畢業", pinyin: "bì yè", zhuyin: "ㄅㄧˋ ㄧㄝˋ" },
  { term: "供用戶製作", pinyin: "gōng yòng hù zhì zuò", zhuyin: "ㄍㄨㄥ ㄩㄥˋ ㄏㄨˋ ㄓˋ ㄗㄨㄛˋ" },
...
const PHONETIC_SURROGATE_LEXICON: ReadonlyArray<{ source: string; surrogate: string }> = [
  ...
  { source: "畢業", surrogate: "必業" },
  { source: "供用戶製作", surrogate: "公用戶制作" },
